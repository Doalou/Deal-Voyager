...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Compare and find the best mobile plans in France."}],"link":[],"style":[],"script":[],"noscript":[],"title":"Deal Voyager - Mobile Plans Analyzer"};
